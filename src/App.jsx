...
/* ═══════════ FLIP CARD ═══════════ */
function NeoFlipCard({w,h,rgb,x,y,r,f,d,dl,title,plain,enc,opacity=1}){
  const[flipped,setFlipped]=React.useState(false);
  return(
    <div onMouseEnter={()=>setFlipped(true)} onMouseLeave={()=>setFlipped(false)} onClick={()=>setFlipped(v=>!v)}
      style={{position:"absolute",left:x,top:y,width:w,height:h,perspective:600,cursor:"pointer",pointerEvents:"auto",opacity,zIndex:5,animation:`neoFloat${f} ${d} ease-in-out infinite ${dl}`}}>
...
@keyframes butterflyFly{0%{transform:translate(0,0) rotate(0deg)}5%{transform:translate(80px,-30px) rotate(4deg)}10%{transform:translate(180px,-50px) rotate(7deg)}15%{transform:translate(260px,-25px) rotate(5deg)}20%{transform:translate(300px,10px) rotate(2deg)}25%{transform:translate(250px,50px) rotate(-3deg)}30%{transform:translate(150px,40px) rotate(-6deg)}35%{transform:translate(50px,20px) rotate(-4deg)}40%{transform:translate(-30px,-10px) rotate(-2deg)}45%{transform:translate(-120px,-45px) rotate(-6deg)}50%{transform:translate(-220px,-60px) rotate(-8deg)}55%{transform:translate(-300px,-30px) rotate(-5deg)}60%{transform:translate(-280px,15px) rotate(-2deg)}65%{transform:translate(-200px,45px) rotate(2deg)}70%{transform:translate(-100px,35px) rotate(5deg)}75%{transform:translate(-20px,15px) rotate(3deg)}80%{transform:translate(40px,-5px) rotate(2deg)}85%{transform:translate(25px,-15px) rotate(1deg)}90%{transform:translate(12px,-8px) rotate(0deg)}95%{transform:translate(4px,-3px) rotate(0deg)}100%{transform:translate(0,0) rotate(0deg)}}
@keyframes butterflyFly2{0%{transform:translate(0,0) rotate(0deg)}4%{transform:translate(-60px,20px) rotate(-3deg)}8%{transform:translate(-150px,55px) rotate(-6deg)}12%{transform:translate(-240px,30px) rotate(-4deg)}18%{transform:translate(-280px,-20px) rotate(-1deg)}24%{transform:translate(-220px,-60px) rotate(3deg)}30%{transform:translate(-110px,-45px) rotate(6deg)}36%{transform:translate(10px,-15px) rotate(4deg)}42%{transform:translate(100px,25px) rotate(2deg)}48%{transform:translate(200px,60px) rotate(5deg)}54%{transform:translate(280px,35px) rotate(7deg)}60%{transform:translate(310px,-10px) rotate(4deg)}66%{transform:translate(260px,-50px) rotate(1deg)}72%{transform:translate(160px,-40px) rotate(-3deg)}78%{transform:translate(70px,-20px) rotate(-4deg)}84%{transform:translate(20px,5px) rotate(-2deg)}90%{transform:translate(-10px,10px) rotate(-1deg)}95%{transform:translate(-4px,4px) rotate(0deg)}100%{transform:translate(0,0) rotate(0deg)}}
    ...
    return(
      <div ref={el=>{ldScrollRef.current=el;if(el)requestAnimationFrame(onLdScroll)}} onScroll={onLdScroll} style={{width:"100%",height:"100vh",overflowY:"auto",overflowX:"hidden",background:T.dark?T.bg:"#0a0a12",color:T.dark?T.text:"#e2e8f0",fontFamily:`${F.body},sans-serif`,position:"relative"}}>
        ...
        <section style={{position:"relative",zIndex:1,minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"120px 24px 80px"}}>
          ...
          <div style={{position:"absolute",top:"35%",left:"55%",animation:"butterflyFly2 24s ease-in-out infinite 3s",filter:`drop-shadow(0 3px 15px rgba(${T.accentRgb},0.3))`,opacity:0.7,pointerEvents:"none"}}>
    ...
    return(
      <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:9999,background:T.dark?`linear-gradient(135deg,${T.bg} 0%,${T.bg2} 50%,${T.bg} 100%)`:`linear-gradient(135deg,${T.bg} 0%,${T.bg2} 50%,${T.bg3} 100%)`,backgroundSize:"400% 400%",animation:"gradientShift 8s ease infinite",fontFamily:`${F.body},sans-serif`,overflow:"hidden",display:"flex",alignItems:"center",justifyContent:"center"}}>
        ...
        <div style={{position:"relative",zIndex:10,textAlign:"center",animation:shake?"shake 0.6s":"fadeUp 0.5s ease-out both",width:400,maxWidth:"100%",padding:"28px 28px",borderRadius:20,background:T.dark?"rgba(255,255,255,0.04)":"rgba(255,255,255,0.08)",backdropFilter:"blur(24px)",WebkitBackdropFilter:"blur(24px)",border:`1px solid rgba(${T.accentRgb},0.2)`,boxShadow:`0 8px 40px rgba(0,0,0,0.25), 0 0 80px rgba(${T.accentRgb},0.08), inset 0 0 0 1px rgba(255,255,255,${T.dark?0.06:0.12}), inset 0 1px 0 rgba(255,255,255,${T.dark?0.08:0.15})`}}>
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:6,marginTop:12,color:T.text,opacity:0.5,fontSize:10,letterSpacing:1}}>
